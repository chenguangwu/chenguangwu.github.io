...
const CASES = [
  { slug: "logistics/analysis-75", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "logistics/analysis-76", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "logistics/analysis-cycle-1", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "logistics/analysis-report", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "logistics/checker-4", inputs: {}, expect: ["未建立"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "logistics/stats-on-time", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 }
];
async function main() {

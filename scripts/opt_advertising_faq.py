#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""advertising 分类 FAQPage 结构化数据注入（三处清理之一：JSON-LD）。
- 删除 advertising 所有 html 中已有的 FAQPage LD 整块（稳健递归判定，避免嵌套 JSON 截取失败），注入前先清空保证幂等。

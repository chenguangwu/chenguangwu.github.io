...
const CASES = [
  ...
  },
  {
    slug: "edu/stats",
    inputs: { data: "2 4 12" },
    expect: ["3", "18.00", "6.00", "4.00", "10.00", "18.67", "4.32"],
    ref: "n=3，sum=18.00，mean=6.00，med=4.00，min=2,max=12,range=10.00，var=((2−6)²+(4−6)²+(12−6)²)/3=(16+4+36)/3=18.67，std=√18.67=4.32",
  },
  {
...
async function main() {
  ...
  console.log("==== edu calc " + pass + "/" + cs.length + " ====");

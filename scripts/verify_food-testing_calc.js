...
const CASES = [
  ...
  { slug: "food-testing/allergen-cross-risk", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "food-testing/ingredient-sorter", inputs: {}, expect: ["的规定"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "food-testing/salmonella-serotype", inputs: {}, expect: ["常见食源性病原体"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "food-testing/summary", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },

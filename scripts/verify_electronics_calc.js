...
const CASES = [
  ...
  { slug: "electronics/convert-capacitance", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "electronics/resistance-resistor", inputs: {}, expect: ["暂无计算记录"], _selfcheck: true, _min_inputs: 0 },

...
const CASES = [
  { slug: "exhibition/analysis-61", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "exhibition/analysis-pnl", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "exhibition/assessor-61", inputs: {}, expect: ["加大投入"], _selfcheck: true, _min_inputs: 0 },
  { slug: "exhibition/assessor-evacuation", inputs: {"area":"5000","capacity":"2000","exits":"4","width":"3","distance":"35","load":"5"}, expect: ["应急广播缺失"] },
  { slug: "exhibition/stats-12", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 }
];
async function main() {

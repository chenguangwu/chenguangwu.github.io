...
},
{
  ...
  "ref": "v0=3000,v1=250 → 单位压力=3000÷250×10=120.00 MPa、设备吨位 3000/9.807=305.90 t、含 1.25 系数 382.38 t（默认 2000/200 → 100.00/203.94/254.92；swap 0.83/25.49/31.86，均不重合）"
},
{
...
},
{
  ...
  "ref": "v0=100000,v1=5000 → 折标煤=(100000×0.1229+5000×1.33)/1000=18.940 tce、减排 CO₂=18.94×2.66=50.38 t、折合 18940.0 kgce（默认 50000/2000 → 8.805/23.42/8805.0；swap 66.746/177.54/66745.8，均不重合）"
},
{
...
},
{
  ...
  "ref": "v0=20000,v1=50 → 单位电耗=20000/50=400.00 kWh/t、吨钢电费 400×0.6=240.00 元/t、单炉电费 20000×0.6=12000.00 元（默认 15000/50 → 300.00/180.00/9000.00；swap 0.00/0.00/30.00，均不重合；相对基准偏差含正负号对称风险，不作 expect）"
},
{
...
},
{
  ...
  "ref": "重做为杠杆定律：C0=0.55 在 [0.20,0.80] 两相区 → fα=(0.80−0.55)/(0.80−0.20)=41.67%、fβ=58.33%、fα+fβ=100%（默认 0.40/0.10/0.90 → [0.10,0.90]，区分）。非默认输入 + 独立复算。"
},
{
  ...
  "ref": "非默认输入+独立复算：均价49.50、振幅77.00、标准差25.20、CV50.92%、±1σ区间[24.30,74.70]（默认45000序列均值为4.5万级，注入失败即不命中）"
},
{

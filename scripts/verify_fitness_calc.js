...
const CASES = [
  ...
  { slug: "fitness/calculator-calc-metabolism", inputs: { sex: "m", age: "40", h: "180", w: "80" },
    expect: ["1730", "1797", "1763"],
    ref: "Mifflin=1730；Harris-Benedict 男=88.362+13.397×80+4.799×180−5.677×40=1796.86→1797；平均=(1730+1796.86)/2=1763.43→1763（默认 30/175/70→1649/1696/1672 避开）" },
...
async function main() {
  ...
  console.log("==== fitness calc " + pass + "/" + cs.length + " ====");

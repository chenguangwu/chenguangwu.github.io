...
const CASES = [
  ...
  { slug: "urology/calc-1", inputs: {}, _min_inputs: 0, expect: ["几乎总是"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "urology/catheter-selection", inputs: {}, _min_inputs: 0, expect: ["胶涂层导管"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "urology/iief5-score", inputs: {}, _min_inputs: 0, expect: ["可能影响评分准确性"], _selfcheck: true, _min_inputs: 0 },
  { slug: "urology/ipss-score", inputs: {}, _min_inputs: 0, expect: ["情变化"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "urology/rater-3", inputs: {}, _min_inputs: 0, expect: ["虑药物治疗"], _selfcheck: true, _min_inputs: 0 },
  { slug: "urology/rater-4", inputs: {}, _min_inputs: 0, expect: ["考虑联合治疗或器械治"], _selfcheck: true, _min_inputs: 0 },
  { slug: "urology/residual-urine", inputs: {"w":"5.0","h":"4.0","d":"4.0","voided":"200"}, expect: ["输入径线"] },
  { slug: "urology/stone-composition", inputs: {}, _min_inputs: 0, expect: ["未找到匹配的结石成分"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "urology/uti-diagnosis", inputs: {}, _min_inputs: 0, expect: ["泌尿道手术前除外"], _selfcheck: true, _min_inputs: 0 },

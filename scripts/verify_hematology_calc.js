...
const CASES = [
  ...
  { slug: "hematology/aps-diagnosis", inputs: {}, _min_inputs: 0, expect: ["未满足临床和实验室标"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "hematology/itp-risk-score", inputs: {}, _min_inputs: 0, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "hematology/leukemia-classification", inputs: {}, _min_inputs: 0, expect: ["缺失"], _selfcheck: true, _min_inputs: 0 },

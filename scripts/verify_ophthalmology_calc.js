...
const CASES = [
  ...
  { slug: "ophthalmology/amsler-grid-test", inputs: {}, _min_inputs: 0, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/analysis-12", inputs: {}, _min_inputs: 0, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/astigmatism-chart", inputs: {}, _min_inputs: 0, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "ophthalmology/detector-6", inputs: {}, _min_inputs: 0, expect: ["建议定期复查"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/eye-chart-toolkit", inputs: {"ecWmm":"521","ecWpx":"1920","ecPpi":"92"}, expect: ["即可"] },
  { slug: "ophthalmology/fluorescein-staining", inputs: {}, _min_inputs: 0, expect: ["颞侧区"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "ophthalmology/ishihara-test", inputs: {}, _min_inputs: 0, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/meibomian-grading", inputs: {}, _min_inputs: 0, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/oct-rnfl", inputs: {"age":"60","g":"78","s":"95","i":"90","n":"65","t":"60"}, expect: ["预期"] },
  { slug: "ophthalmology/osdi-scale", inputs: {}, _min_inputs: 0, expect: ["全部时间"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/pterygium-measurement", inputs: {"cd":"11.5","head":"2.0","width":"4.0","length":"5.0"}, expect: ["充血"] },
  { slug: "ophthalmology/pupil-reflex", inputs: {}, _min_inputs: 0, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/rater-7", inputs: {}, _min_inputs: 0, expect: ["定期复查"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/rater-8", inputs: {}, _min_inputs: 0, expect: ["保持良好的用眼习惯即"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "ophthalmology/self-assess-2", inputs: {}, _min_inputs: 0, expect: ["保持环境湿度"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "ophthalmology/vision-screening-21", inputs: {}, _min_inputs: 0, expect: ["总是"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ophthalmology/visual-acuity-converter", inputs: {"value":"1"}, expect: ["请输入有效数值"], _selfcheck: true, _min_inputs: 1 },
  { slug: "ophthalmology/visual-fatigue-vas", inputs: {}, _min_inputs: 0, expect: ["持续"], _selfcheck: true, _min_inputs: 0 },

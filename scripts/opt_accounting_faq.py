# -*- coding: utf-8 -*-
"""accounting 35 工具：删旧套话 FAQPage LD + 注入真实 FAQPage LD + title 加"免费"。
...
def main():
    ...
    files.sort()
    print("processing %d accounting tools (dry=%s)" % (len(files), dry))
    for f in files:
        slug = f[:-5]

...
const CASES = [
  { slug: "ent/adenoid-grading", inputs: {}, expect: ["可先保守治疗"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "ent/calc-1", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/caloric-test", inputs: {"rw":"25","lw":"22","rc":"20","lc":"18"}, expect: ["阈值"] },
  { slug: "ent/eustachian-tube", inputs: {}, expect: ["咽鼓管开放程度"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/facial-nerve-hb", inputs: {}, expect: ["面神经功能障碍程度"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/fistula-test", inputs: {"positivePressure":"300","negativePressure":"200"}, expect: ["系统将自动给出评估结"] },
  { slug: "ent/gag-reflex", inputs: {}, expect: ["无需特殊处理"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/grbas-scale", inputs: {}, expect: ["嗓音障碍程度"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "ent/lund-kennedy-score", inputs: {}, expect: ["炎症严重度"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/lund-mackay-score", inputs: {}, expect: ["病变程度"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/nasal-resistance", inputs: {"lp":"150","lv":"350","rp":"150","rv":"400"}, expect: ["轻度升高"] },
  { slug: "ent/pure-tone-audiometry", inputs: {}, expect: ["频率"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/tdi-score", inputs: {"scoreT":"6","scoreD":"10","scoreI":"11"}, expect: ["嗅觉功能"] },
  { slug: "ent/temporal-resolution-hearing", inputs: {}, expect: ["力与耳科检查"], _selfcheck: true, _min_inputs: 0 },
  { slug: "ent/tinnitus-matching", inputs: {"loudness":"5","masking":"50"}, expect: ["多与耳蜗病变相关"] },
  { slug: "ent/tonsil-grading", inputs: {}, expect: ["可保守治疗观察"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "ent/vocal-cord-assessment", inputs: {}, expect: ["无需特殊处理"], _selfcheck: true, _min_inputs: 0 }
];
async function main() {

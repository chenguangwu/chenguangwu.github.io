...
const CASES = [
  ...
  { slug: "misc/number-puzzle", inputs: {}, expect: ["参考解法"], _selfcheck: true, _min_inputs: 0 },
  { slug: "misc/physics-constants", inputs: {}, expect: ["天文"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "misc/truth-table", inputs: {}, expect: ["变量"], _selfcheck: true, _min_inputs: 0 },

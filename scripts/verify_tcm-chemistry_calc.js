...
const CASES = [
  ...
  { slug: "tcm-chemistry/convert-41", inputs: {}, _min_inputs: 0, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "tcm-chemistry/detector-4", inputs: {}, _min_inputs: 0, expect: ["不涵盖所有中药相互作"], _selfcheck: true, _min_inputs: 0 },
  { slug: "tcm-chemistry/extraction-counts", inputs: {"K":"5","ratio":"0.5","target":"95","total":"100"}, expect: ["需要"] },
  { slug: "tcm-chemistry/extraction-solvent", inputs: {}, _min_inputs: 0, expect: ["相似相溶原理"], _selfcheck: true, _min_inputs: 0 },
  { slug: "tcm-chemistry/fingerprint-similarity", inputs: {}, _min_inputs: 0, expect: ["敏感"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "tcm-chemistry/solubility-guide", inputs: {}, _min_inputs: 0, expect: ["未找到匹配成分"], _selfcheck: true, _min_inputs: 0 },

...
const CASES = [
  ...
  { slug: "signal/carrier-freq", inputs: { fu: "1200", fl: "800" }, expect: ["1000.000 载波频率"], ref: "f_c=(fu+fl)/2=(1200+800)/2=1000" },
  ...
  { slug: "signal/group-delay", inputs: { dp: "-90", dw: "1000" }, expect: ["0.001571 群时延"], ref: "τ_g=-(dp·π/180)/dw=-(-90·π/180)/1000=0.001571s" },
  ...
  { slug: "signal/snr-db", inputs: { ps: "100", pn: "1" }, expect: ["20.000 信噪比"], ref: "SNR=10·log₁₀(Ps/Pn)=10·log₁₀(100)=20dB" },

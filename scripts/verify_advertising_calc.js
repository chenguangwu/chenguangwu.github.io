...
},
{
  ...
  "inputs": { "data": "5,9,13,21,14" },
  "expect": ["平均值： 12.40", "方差： 28.64"],
  "ref": "原断言为 textarea 回显「80_X」（注入失败也命中）；独立复算：n=5、和=62、均值=12.4、中位=13、极差=16、总体方差=143.2/5=28.64、标准差=5.35。默认数据 10..80 → 均值 45.00 / 方差 525.00。"
},
{
  "slug": "advertising/analysis-55",
  "inputs": { "data": "5,9,13,21,14" },
  "expect": ["平均值： 12.40", "方差： 28.64"],
  "ref": "同 analysis-27（两页为同一段通用描述统计实现，见 DEV-PLAN §10.6 缺陷 F 同类现象）。"
},
{

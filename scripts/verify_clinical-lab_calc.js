...
const CASES = [
  { slug: "clinical-lab/analysis-8", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "clinical-lab/analysis-9", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "clinical-lab/analysis-density-2", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "clinical-lab/autoantibody-interpretation", inputs: {}, expect: ["但不能完全排除"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "clinical-lab/parasite-egg-id", inputs: {}, expect: ["未找到匹配的虫卵"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "clinical-lab/urinalysis-interpretation", inputs: {}, expect: ["阴性"], _selfcheck: true, _min_inputs: 0 },
  { slug: "clinical-lab/urine-sediment-atlas", inputs: {}, expect: ["未找到匹配项目"], _selfcheck: true, _min_inputs: 0 },
  { slug: "clinical-lab/vaginal-discharge-grading", inputs: {}, expect: ["多见于月经周期某阶段"], _selfcheck: true, _min_inputs: 0 }
];
async function main() {

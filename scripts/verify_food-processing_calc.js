  ...
  // 注：food-processing/estimate-analysis-1 已于 2026-09-19 改为 TOOLBOX-REDIRECT 存根（重定向到同义真工具），不再是工具页，用例移除。
{
  ...
  "clicks": ["ins=[{name:'原料乳',qty:1250},{name:'白砂糖',qty:180}];outs=[{name:'成品酸奶',qty:1180},{name:'清洗损耗',qty:150}];calc()"],
  "expect": [
    "1430.00 总投入",
    "100.00 损耗",
    "93.01%"
  ],
  "ref": "顶层数组 ins/outs 注入（页面无任何 id 控件）：总投入 1250+180 = 1430.00、总产出 1180+150 = 1330.00、损耗 100.00、得率 1330/1430×100 = 93.01%（损耗率 6.99%）。默认态为源码字面量 180/160 ⇒ 88.89%，三串均不命中。"
},
{

...
const CASES = [
  ...
  { slug: "fire/detector-176", inputs: {}, _min_inputs: 0, expect: ["测维护"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "fire/response-drill", inputs: {}, _min_inputs: 0, expect: ["再来一次"], _selfcheck: true, _min_inputs: 0 },

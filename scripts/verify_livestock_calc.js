...
const CASES = [
  ...
  { slug: "livestock/analysis-18", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "livestock/animal-welfare-score", inputs: {}, expect: ["动物福利状况优秀"], _selfcheck: true, _min_inputs: 0 },
  { slug: "livestock/breeding-timing", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "livestock/calc-58", inputs: {}, expect: ["暂无计算记录"], _selfcheck: true, _min_inputs: 0 },
  { slug: "livestock/calving-interval", inputs: {"daysToFirstBreed":"75","breedTimes":"2","gestation":"283"}, expect: ["繁殖效率良好"] },
  { slug: "livestock/castration-timing", inputs: {}, expect: ["且所选动物支持该操作"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "livestock/milk-yield-scc", inputs: {}, expect: ["采食量及热应激等因素"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "livestock/stats-7", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "livestock/vaccine-schedule", inputs: {}, expect: ["三免"], _selfcheck: true, _min_inputs: 0 },

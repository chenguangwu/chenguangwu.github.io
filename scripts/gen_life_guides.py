...
TOOLS_DIR = os.path.join(ROOT, "tools", "life")
IND = "life"
DATE = "2026-09-13"
SITE = "https://chenguangwu.github.io"

from fix_life_formula_map import MAP as FORMULA_MAP  # noqa: E402
...
def build_content():
    gis = load_json(os.path.join(ROOT, "i18n", "tools", "life.json"))

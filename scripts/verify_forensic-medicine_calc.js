...
const CASES = [
  ...
  { slug: "forensic-medicine/analysis-15", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "forensic-medicine/blood-stain-screening", inputs: {}, expect: ["分型进行个体识别"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "forensic-medicine/dna-str-typing", inputs: {}, expect: ["人混合来源"], _selfcheck: true, _min_inputs: 0 },
  { slug: "forensic-medicine/drowning-diatom", inputs: {"organ_' + i + '":"50"}, expect: ["建议同时送检溺水点水"], _selfcheck: true, _min_inputs: 1 },
  { slug: "forensic-medicine/electrocution-injury", inputs: {}, expect: ["结合现场电源情况"], _selfcheck: true, _min_inputs: 0 },
  { slug: "forensic-medicine/fall-injury", inputs: {"fallHeight":"10","bodyWeight":"70","age":"40"}, expect: ["年龄骨密度等因素影响"] },
  { slug: "forensic-medicine/fracture-age", inputs: {}, expect: ["可能残留增粗"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "forensic-medicine/livor-mortis", inputs: {}, expect: ["新体位也不出现新尸斑"], _selfcheck: true, _min_inputs: 0 },
  { slug: "forensic-medicine/poisoning-screening", inputs: {}, expect: ["筛查"], _selfcheck: true, _min_inputs: 0 },
  { slug: "forensic-medicine/rigor-mortis", inputs: {}, expect: ["消失"], _selfcheck: true, _min_inputs: 0 },
  { slug: "forensic-medicine/semen-stain-confirmation", inputs: {}, expect: ["分型个体识别"], _selfcheck: true, _min_inputs: 0 },

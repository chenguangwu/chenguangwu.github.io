...
const CASES = [
  ...
  { slug: "automotive/auto-beauty-calc-1", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "automotive/cycle-13", inputs: {}, expect: ["未记录"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "automotive/fuel-anomaly", inputs: {}, expect: ["拆除不必要的物品"], _selfcheck: true, _min_inputs: 0 },

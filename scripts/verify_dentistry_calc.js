...
const CASES = [
  ...
  { slug: "dentistry/analysis-11", inputs: {}, _min_inputs: 0, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "dentistry/bridge-span", inputs: {}, _min_inputs: 0, expect: ["固定桥设计可行"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "dentistry/caries-risk", inputs: {}, _min_inputs: 0, expect: ["保持口腔清洁与用氟"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "dentistry/gingival-index", inputs: {}, _min_inputs: 0, expect: ["必要时药物治疗"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "dentistry/oral-cancer-screening", inputs: {}, _min_inputs: 0, expect: ["制定方案"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "dentistry/rater-risk-2", inputs: {}, _min_inputs: 0, expect: ["复查"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "dentistry/sialography", inputs: {}, _min_inputs: 0, expect: ["征后判读"], _selfcheck: true, _min_inputs: 0 },
  { slug: "dentistry/tongue-oral-health", inputs: {}, _min_inputs: 0, expect: ["口腔疾病"], _selfcheck: true, _min_inputs: 0 },
  { slug: "dentistry/tooth-preparation", inputs: {"angle":"10","height":"5","diameter":"8"}, expect: ["可常规修复"] },
  { slug: "dentistry/wisdom-tooth", inputs: {}, _min_inputs: 0, expect: ["常规手术即可"], _selfcheck: true, _min_inputs: 0 },
  { slug: "dentistry/zirconia-aesthetics", inputs: {}, _min_inputs: 0, expect: ["材料选择与需求匹配良"], _selfcheck: true, _min_inputs: 0 }
];
async function main() {

...
const CASES = [
  { slug: "cleaning/appliance-cycle", inputs: {}, expect: ["记录今日"], _selfcheck: true, _min_inputs: 0 },
  { slug: "cleaning/area-hours", inputs: {"area":"100","staff":"2"}, expect: ["总分钟数"] },
  { slug: "cleaning/checker-10", inputs: {}, expect: ["限期整改并安排复查"], _selfcheck: true, _min_inputs: 0 },
  { slug: "cleaning/checker-9", inputs: {}, expect: ["未制定"], _selfcheck: true, _min_inputs: 0 },

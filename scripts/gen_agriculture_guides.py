...
# -*- coding: utf-8 -*-
"""
agriculture 分类「使用指南」生成器（批次 D）。

数据驱动（不手写 64 篇文案，全部取自已有真实数据源，避免套话）：
  - 标题 / 简介：i18n/tools/agriculture.json 的 zh-CN.title / intro
...
TOOLS_DIR = os.path.join(ROOT, "tools", "agriculture")
IND = "agriculture"
DATE = "2026-09-13"
SITE = "https://chenguangwu.github.io"

from fix_agriculture_formula_map import MAP as FORMULA_MAP  # noqa: E402
...
def build_content():
    gis = load_json(os.path.join(ROOT, "i18n", "tools", "agriculture.json"))

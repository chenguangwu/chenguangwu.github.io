...
const CASES = [
  { slug: "food/analysis-cost-6", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "food/analysis-menu", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "food/convert-20", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "food/food-calorie-counter", inputs: {}, expect: ["点击上方食物开始记录"], _selfcheck: true, _min_inputs: 0 },
  { slug: "food/food-pairing", inputs: {}, expect: ["搭配分析"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "food/recipe-generator", inputs: {}, expect: ["换一个菜谱"], _selfcheck: true, _min_inputs: 0 },
  { slug: "food/report-cost-profit", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "food/soup-ratio-optimizer", inputs: {"soupVol":"1000"}, expect: ["成人每日盐摄入建议"], _selfcheck: true, _min_inputs: 1 },
  { slug: "food/stats-ingredient", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },
  { slug: "food/stats-simulator-flavor", inputs: {}, expect: ["标准差"], _selfcheck: true, _min_inputs: 0 },

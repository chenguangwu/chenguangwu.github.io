...
const CASES = [
  { slug: "hotel/assessor-62", inputs: {}, expect: ["推荐加盟"], _selfcheck: true, _min_inputs: 0 },
  { slug: "hotel/checker-assessor", inputs: {}, expect: ["可作为标杆推广"], _selfcheck: true, _min_inputs: 0 },
...
async function main() {
  ...
  console.log("==== hotel calc " + pass + "/" + cs.length + " ====");

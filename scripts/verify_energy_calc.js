...
const CASES = [
  ...
  // ── 空气净化器适用面积 ≈ CADR × 系数 ───────────────────────────
  {
    ...
    inputs: { cadrInput: "550", factorInput: "0.08" },
    expect: ["55", "55.0"],
    // 页面实现：recArea = cadr × 0.1（硬编码），factorInput 仅用于展示、未参与计算 —— 已记为待修缺陷
    ref: "推荐面积 = CADR×0.10 = 550×0.10 = 55.0 m²（最小 0.07×550 = 38.5，最大 0.12×550 = 66）",
  },
];

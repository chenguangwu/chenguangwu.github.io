...
const CASES = [
  ...
  // ── 耗电量与电费 E = P×t/1000；电费 = E×单价 ──────────────────────
  {
    ...
    expect: ["10.00 耗电量", "8.00 电费", "2.000 平均每小时耗电", "240.00 按 30 天估算电费"],
    ref: "E = 2000×5/1000 = 10.00 kWh；电费 = 10.00×0.8 = 8.00 元；平均每小时耗电 = E/t = 10.00/5 = 2.000 kWh/h（原实现 kwh/(t/60) 多乘 60 得 120.000）；30 天电费 = 8.00×30 = 240.00 元",
  },
  ...
  // ── 电池续航（mAh → Wh，含效率） ─────────────────────────────────
  {
    ...
    expect: ["18.00 Wh", "16.20 Wh", "486 分钟", "中度使用 (100%) 8时 6分", "重度使用 (200%) 4时 3分"],
    ref: "Wh = 5000×3.6/1000 = 18.00；可用 = 18.00×90% = 16.20；续航 = 16.20/2 = 8.10 h = 486 分钟；中度使用 = usable/p = 8.10 h → 8时 6分（原实现多除以 60，显示成「8分钟」）；重度使用 = 16.20/4 = 4.05 h → 4时 3分",
  },

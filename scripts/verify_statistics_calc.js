...
const CASES = [
  ...
  // ── 四分位距与异常值边界（Tukey 1.5×IQR）────────────────────────
  {
    ...
    expect: ["30.0000", "-25.0000", "95.0000", "35.0000"],
  ...
  // ── 标准差/方差/CV（固定 7 个数据，样本分母 n−1）────────────────
  {
    ...
    inputs: { n1: "1", n2: "3", n3: "5", n4: "7", n5: "9", n6: "11", n7: "13", type: "1" },
    expect: ["18.6667", "4.3205", "61.72"],
    ref: "均值 = 7.0；Σ(x−7)² = 112.0；方差 = 112.0/6 = 18.6667；标准差 = 4.3205；CV = 61.72%",
  },
  // ── 偏度与超额峰度（总体矩）─────────────────────────────────────
  {

...
const CASES = [
  ...
  {
    slug: "securities/calc-30",
    inputs: { series: "100\n120\n90\n110", freq: "12", rf: "0" },
    expect: ["25.00%", "33.10%", "1.324"],
    ref: "复合年化与最大回撤：4 期月度净值 100→120→90→110。MDD=(90−120)/120=−25.00%；years=4/12=0.3333，CAGR=(110/100)^(1/0.3333)−1=1.1^3−1=33.10%；excess=0.331−0=0.331，Calmar=0.331/0.25=1.324。验证 CAGR 年化公式不被默认高频误放大（修复前默认 freq=252 使 13 点样本年化 ~67900% 荒谬）。textarea 序列在判别器判跳过属正常",
  },
];

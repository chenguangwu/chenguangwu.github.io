...
const CASES = [
  ...
  { slug: "nephrology/nephrotic-syndrome", inputs: {}, expect: ["多数预后良好"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "nephrology/renal-biopsy", inputs: {}, expect: ["对激素敏感"], _selfcheck: true, _min_inputs: 0 },

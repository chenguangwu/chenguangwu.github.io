...
const CASES = [
  ...
  { slug: "edu2/exam-countdown", inputs: {}, expect: ["个周末"], _selfcheck: true, _min_inputs: 0 },
  { slug: "edu2/schedule-conflict", inputs: {}, expect: ["课程表安排合理"], _selfcheck: true, _min_inputs: 0 },

...
const CASES = [
  ...
  { slug: "cardiology/antiarrhythmic-class", inputs: {}, expect: ["增宽"], _selfcheck: true, _min_inputs: 0 },
  { slug: "cardiology/aortic-dissection", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "cardiology/calc-3", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  { slug: "cardiology/cardiac-rehab-mets", inputs: {"mets":"5","weight":"70"}, expect: ["高强度间歇训练"] },
  { slug: "cardiology/chads2-vasc", inputs: {}, expect: ["无需口服抗凝药"], _selfcheck: true, _min_inputs: 0 },
  { slug: "cardiology/ckd-epi", inputs: {"age":"65","scr":"1.3","uacr":"80"}, expect: ["考虑"] },
  { slug: "cardiology/convert-rehab", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "cardiology/has-bled", inputs: {}, expect: ["结果"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "cardiology/rater-11", inputs: {}, expect: ["应寻找并纠正可逆原因"], _selfcheck: true, _min_inputs: 0 },
  ...
  { slug: "cardiology/timi-score", inputs: {}, expect: ["治疗决策"], _selfcheck: true, _min_inputs: 0 }
];
async function main() {

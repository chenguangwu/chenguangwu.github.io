...
const CASES = [
  ...
  { slug: "legal2/ip-protection", inputs: {}, expect: ["申请日期"], _selfcheck: true, _min_inputs: 0 },
  { slug: "legal2/keyword-extract", inputs: {}, expect: ["不替代专业法律分析"], _selfcheck: true, _min_inputs: 0 },

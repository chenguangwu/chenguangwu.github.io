...
const HOT_TOOLS = [
  ...
  { n: '单位换算',         en: 'Unit Converter',      d: '全面的单位转换器',                  ed: 'Comprehensive unit converter',            i: 'life',   c: 'convert',   u: 'tools/life/converter.html',    ic: '🔄', b: '#e0f7fa' },
  ...
  { n: 'UUID 生成',        en: 'UUID Generator',      d: '生成各种格式的 UUID',               ed: 'Generate UUIDs in various formats',       i: 'it',     c: 'generate',  u: 'tools/it/uuid.html',           ic: '🆔', b: '#fff8e1' },

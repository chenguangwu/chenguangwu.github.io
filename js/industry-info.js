...
window.INDUSTRY_INFO = {
  ...
  'accounting'           : { name: '会计在线工具集合 - 免费实用的会计计算器与助手', icon: '🧾' },
  'acoustics'            : { name: '声学', icon: '🔊' },
  'acupuncture'          : { name: '针灸推拿', icon: '🪡' },
  'admin'                : { name: '行政管理', icon: '🗂️' },
  'advertising'          : { name: '广告在线工具集合 - 免费实用的广告计算器与助手', icon: '📣' },
  'aerospace'            : { name: '航空航天', icon: '🚀' },
  'agriculture'          : { name: '农业在线工具集合 - 免费实用的农业计算器与助手', icon: '🌾' },
  'ai'                   : { name: '人工智能', icon: '🔧' },
  ...
  'biz'                  : { name: '商业在线工具集合 - 免费实用的商业计算器与助手', icon: '💼' },
  ...
  'design'               : { name: '设计在线工具集合 - 免费实用的设计生成器与助手', icon: '🎨' },
  ...
  'finance'              : { name: '财务金融在线工具集合 - 免费实用的金融计算器与助手', icon: '💰' },
  'fire'                 : { name: '消防安全', icon: '🚒' },
  ...
  'general'              : { name: '通用在线工具集合 - 免费实用的通用计算器与助手', icon: '⚙️' },
  ...
  'it'                   : { name: 'IT开发在线工具集合 - 免费实用的开发者工具与助手', icon: '💻' },
  ...
  'math'                 : { name: '数学在线工具集合 - 免费实用的数学计算器与助手', icon: '🧮' },
  ...
  'science'              : { name: '科学在线工具集合 - 免费实用的科学计算器与助手', icon: '🔬' },
  ...
  'sports'               : { name: '体育在线工具集合 - 免费实用的体育计算器与助手', icon: '⚽' },

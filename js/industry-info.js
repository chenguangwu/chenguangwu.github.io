...
window.INDUSTRY_INFO = {
  ...
  'legal'                : { name: '法律合规', icon: '🔧' },
  'legal2'               : { name: '劳动法律', icon: '🔧' },
  ...
  'thermodynamics'       : { name: '热力学', icon: '🔧' },
  'timber'               : { name: '木材加工', icon: '🪵' },
  'transport'            : { name: '交通运输', icon: '🚚' },
  'travel'               : { name: '旅行出行', icon: '🔧' },

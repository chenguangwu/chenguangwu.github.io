...
- ✅ agriculture (63)：八项目标全覆盖（deep-dive 63/63 达 §4.5、英文态八维全清零、formula 客观口径补框 55/55、计算验证 12/12（第 16 道门禁 verify_agriculture_calc.js）、指南 2→63；部署待 run 核验），git 实测

> 跳过规则：上述分类**不列入 §9.2 待办**；其余分类按 §9.2 热度顺序从零推进。

### 9.2 分类优化清单（254 分类，按热度降序，完成一个删一个）

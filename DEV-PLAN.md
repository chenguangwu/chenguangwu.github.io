...
> **收口状态（2026-09-19）**：`it` ✅ 336/336 A；`general` ✅ 183/183 A（含 §九 缺陷 I「重做」路线 9 页 + `convert-21`/`convert-22`/`convert-content`/`liangshuzhihe-chengjizuida-zuixiao-shuxueti` 4 页 B→A）。**下一个待收口分类 = `design`（111 工具）。**

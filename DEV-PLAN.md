...
- tcm-diagnosis 21 工具（中医病历模板、病因辨证树、证候要素、十问、八纲、卫气营血、三焦、经络、脏腑、六经/方证、舌诊、脉诊、闻诊、神、治则、病性、误治训练、体质辨识、辨病追踪、问诊自测 等）deep-dive 已真实化（apply 落盘 JSON，tcm-diagnosis 范围六型扫描零残留），HTML 重建+5 门禁+commit 待 Bash 恢复执行。

## 九、分类总清单（待办，完成一个删一个；剩 86 个目录）

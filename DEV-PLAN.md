...
| # | 分类 | 工具数 | # | 分类 | 工具数 |
|---|---|---|---|---|---|
| 1 | automotive | 55 | 5 | statistics | 51 |
| 2 | legal | 54 | 6 | edu | 49 |
| 3 | realestate | 54 | 7 | marketing | 46 |
| 4 | meteorology | 42 | 8 | surveying | 44 |
| 5 | (按同口径递减) | — | | | |
...
> **收口状态（2026-09-19）**：`it` ✅ 336/336 A；`general` ✅ 183/183 A；`design` ✅ 109/109 A；`finance` ✅ 104/104 A；`science` ✅ 98/98 A；`sports` ✅ 八维审计全绿；`life`/`biz`/`fun` ✅ 八维审计全绿；`ai`/`agriculture` ✅ 八维审计全绿；`hydraulic` ✅ 八维审计全绿（cat 1 错标修 / 56/56）。**下一个待收口分类 = `automotive`（55 工具）。**
